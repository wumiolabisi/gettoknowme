    ...
    return (
        <div className="text-center">
            <Reveal>
                ...
                <Link className="uppercase text-4xl font-bold" href="mailto:wumi.olabisi@gmail.com" title="Envoyer un email à Omowumi OLABISI" alt="Envoyer un email à Omowumi OLABISI">wumi.olabisi@gmail.com</Link>
            </Reveal>
            <Reveal>
