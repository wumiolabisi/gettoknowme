        ...
        <>
            ...
            <Reveal>
                <article className="my-10 pb-10 border-b-2 border-solid border-b-gray-700">
                    ...
                    <p className="text-green-300 text-xl">1 an (2023-2024)</p>
            ...
            <Reveal>
                <article className="my-10 pb-10 border-b-2 border-solid border-b-gray-700">
                    ...
                    <p className="text-green-300 text-xl">2 ans (2021-2023)</p>
                    ...
                    <section className="my-4 flex flex-row flex-wrap justify-start items-center gap-2">
                        ...
                        <span className="badge rounded-full bg-zinc-700 text-green-300 text-sm">WooCommerce</span>
                        <span className="badge rounded-full bg-zinc-700 text-green-300 text-sm">HTML5/CSS3/JS</span>
                        <span className="badge rounded-full bg-zinc-700 text-green-300 text-sm">PHP</span>
                        <span className="badge rounded-full bg-zinc-700 text-green-300 text-sm">Optimisation SEO</span>
                        <span className="badge rounded-full bg-zinc-700 text-green-300 text-sm">Maintenance</span>
                        <span className="badge rounded-full bg-zinc-700 text-green-300 text-sm">Création de contenus</span>
                    </section>
                </article>
            </Reveal>
        </>
