    ...
    return (
        <>
            <article>
                ...
                <ul>
                    <li className="mb-2"><span className="badge rounded-full bg-gray-500 text-white text-sm">ADRESSE</span> <Link href="https://page28.fr" target="_blank" title="Rendez-vous sur le site Page28" alt="Cliquez ici pour accéder au site page28.fr" className="hover:text-fuchsia-700">page28.fr</Link></li>
